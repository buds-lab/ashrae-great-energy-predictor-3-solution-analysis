...
from ashrae.utils import DATA_PATH, load_data, reduce_mem_usage
...
if __name__ == "__main__":
    ...
    train.to_pickle(f"{DATA_PATH}/train_clean.pkl")
    test.to_pickle(f"{DATA_PATH}/test_clean.pkl")